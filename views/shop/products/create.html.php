<main>
    ...
    <div class="headers">
        <div class="headers-child">
            ...
            <h2 class="headers-title">Ajouter un produit.</h2>
        </div>
    ...
    <?php if (count($categories) > 0) { ?>
        ...
        <form action="/shop/products/create" class="form" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-info">
                ...
                <div class="form-info-child">
                    ...
                    <select name="category_id" id="" class="form-info-child-select">
                        <option value="" class="form-info-child-select-option" selected disabled>Sélectionner une catégorie</option>
                ...
                <div class="form-info-child">
                    ...
                    <textarea
                        ...
                        placeholder="Décrivez votre produit, ses qualités, son origine"></textarea>
